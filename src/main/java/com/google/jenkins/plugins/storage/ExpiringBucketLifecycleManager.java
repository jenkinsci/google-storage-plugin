...
/**
 * A simple implementation of the bucket lifecycle extension point that surfaces
 * object expiration (aka TTL).
 */
public class ExpiringBucketLifecycleManager
    ...
    /**
     * Construct the simple lifecycle manager from a TLL and the common
     * properties.
     */
    ...
    public ExpiringBucketLifecycleManager(String bucket,
        ...
        this.bucketObjectTTL = firstNonNull(ttl, bucketObjectTTL);
    }
