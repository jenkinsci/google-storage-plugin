...
public class RetryStorageOperation {
    ...
    /**
     * Perform the given operation retrying on error. The operation is retried
     * if either IOException or InterruptedException occur. After the given
     * number of retries, throws the last error received. Any other exceptions
     * are passed through.
     *
